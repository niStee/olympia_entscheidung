  ...
  return (
    <PageLayout>
      ...
      <div className="prose prose-neutral max-w-none text-neutral-600">
        ...
        <p>
          Dieses Projekt ist ein privates, unabhängiges Angebot. Der Ersteller ist zwar Mitglied
          von Volt, die Website wurde jedoch nicht im Auftrag der Partei erstellt und
          widerspiegelt nicht die Meinung der Partei.
        </p>
      </div>
    </PageLayout>
  );
