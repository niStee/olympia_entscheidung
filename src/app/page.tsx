...
export default function HomePage() {
  ...
  return (
    <PageLayout>
      ...
      />
      {/* Hero */}
      <section className="hero-gradient -mx-4 px-4 py-16 sm:py-24 text-center rounded-b-3xl mb-8" aria-labelledby="hero-heading">
        ...
        <Button href="/fragen" size="lg" className="text-lg px-10 py-5 shadow-lg shadow-primary-200">
          {hero.ctaLabel}
        </Button>
      </section>
