      ...
      <div className="flex flex-col gap-6">
        ...
        <Card as="section">
          ...
          <ol className="text-sm text-neutral-600 leading-relaxed space-y-2 list-decimal list-inside">
            ...
            <li>
              Die Einzelwerte werden zu einem Rohscore summiert.
            </li>
            <li>
            ...
            <li>
              ...
              Zustimmung. <span className="font-semibold text-neutral-800">50</span> ist der neutrale
              Mittelpunkt.
            </li>
            <li>
            ...
            <li>
              Wurden keine Fragen beantwortet, wird 50 (neutral) ausgegeben.
            </li>
          </ol>
        </Card>
        ...
        >
          ...
          Dieses Tool ist eine Orientierungshilfe. Das Ergebnis spiegelt die Tendenz deiner Antworten
          wider – es stellt keine politische Empfehlung dar und ersetzt keine eigene Urteilsbildung.
          Alle Inhalte und Fragen wurden nach bestem Wissen neutral formuliert.
        </div>
      </div>
    </PageLayout>
  );
