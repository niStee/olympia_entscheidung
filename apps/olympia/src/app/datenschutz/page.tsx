      ...
      <div className="space-y-6 text-neutral-600 leading-relaxed">
        ...
        <section>
          ...
          <p>
            ...
            Erfasst wird, ob ein Browser die Website aufgerufen hat, ob der Wahl-Check bis zum Ende
            durchgeklickt wurde und welcher Ergebnis-Score dabei berechnet wurde. Es gibt kein
        ...
        <section>
          ...
          <p>
            ...
            vermeiden. Es kommen keine externen Tracking-Dienste, Analyse-Tools (z.&thinsp;B. Google
            Analytics), Werbenetzwerke oder sonstige Dienste Dritter zum Einsatz.
          </p>
          <p className="mt-2">
        ...
        <section>
          ...
          <p>
            Die verwendeten Schriftarten (Inter) werden über Next.js lokal eingebunden und direkt
            von diesem Server ausgeliefert. Es findet keine Verbindung zu externen
        ...
        <section>
          ...
          <p>
            ...
            ausschließlich statische Ressourcen (HTML, CSS, JavaScript, Bilder) im Browser-Cache, um
            die Anwendung auch ohne Internetverbindung verfügbar zu machen. Es werden keine
        ...
        <section>
          ...
          <p>
            Diese Datenschutzerklärung kann bei Bedarf aktualisiert werden. Die aktuelle Fassung ist
