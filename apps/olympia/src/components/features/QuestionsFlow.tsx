...
export function QuestionsFlow({ questionsContent }: QuestionsFlowProps) {
  ...
  return (
    <div>
      <ProgressBar current={currentQuestion + 1} total={questions.length} className="mb-6" />
      ...
      <div className="flex gap-3 mt-4">
        ...
        <Button variant="primary" onClick={handleNext} disabled={!hasAnswer} className="flex-1">
