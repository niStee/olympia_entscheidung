...
const ANSWER_OPTIONS: Array<{
...
}> = [
  {
    ...
    label: "Dafür",
    icon: "👍",
    activeClass: "border-emerald-600 bg-emerald-50 text-emerald-900 shadow-sm",
  },
  {
    value: "lean-agree",
    label: "Eher dafür",
  ...
  },
  {
    ...
    label: "Egal",
    icon: "😐",
    activeClass: "border-neutral-400 bg-neutral-100 text-neutral-800",
  },
  {
    value: "lean-disagree",
    label: "Eher dagegen",
  ...
  },
  {
    ...
    label: "Dagegen",
    icon: "👎",
    activeClass: "border-rose-600 bg-rose-50 text-rose-900 shadow-sm",
  },
];
...
const RELEVANCE_OPTIONS: Array<{
...
}> = [
  {
    value: "low",
    label: "Unwichtig",
    activeClass: "border-sky-400 bg-sky-50 text-sky-800 shadow-sm",
  },
  {
    value: "normal",
    label: "Neutral",
  ...
  },
  {
    value: "important",
    label: "Wichtig",
    activeClass: "border-primary-500 bg-primary-50 text-primary-800",
  },
];
